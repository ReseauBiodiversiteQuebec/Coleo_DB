-------------------------------------------------------------------------------
-- VIEW api.gabarit_acoustique_anoures_long
-- DESCRIPTION Representation of the data for the acoustique_anoures campaigns
-------------------------------------------------------------------------------

-- CREATE VIEW FOR ACOUSTIQUE ANOURES CAMPAIGN
-- View: api.gabarit_acoustique_anoures_long

-- DROP VIEW api.gabarit_acoustique_anoures_long;

CREATE OR REPLACE VIEW api.gabarit_acoustique_anoures_long AS (
    ...
    where c.type = 'acoustique_anoures'
    order by (c.opened_at, s.site_code, c.technicians, c.notes)
);

GRANT SELECT ON TABLE api.gabarit_acoustique_anoures_long TO coleo_test_user;
GRANT ALL ON TABLE api.gabarit_acoustique_anoures_long TO glaroc;
GRANT ALL ON TABLE api.gabarit_acoustique_anoures_long TO postgres;
GRANT SELECT ON TABLE api.gabarit_acoustique_anoures_long TO read_only_all;
GRANT SELECT ON TABLE api.gabarit_acoustique_anoures_long TO read_only_public;
GRANT SELECT ON TABLE api.gabarit_acoustique_anoures_long TO read_write_all;


-------------------------------------------------------------------------------
-- VIEW api.gabarit_acoustique_anoures_short
-- DESCRIPTION Short representation of the data for the acoustique_anoures campaign
-------------------------------------------------------------------------------

-- CREATE VIEW FOR ACOUSTIQUE ANOURES CAMPAIGN
-- View: api.gabarit_acoustique_anoures_short

-- DROP VIEW api.gabarit_acoustique_anoures_short;

CREATE OR REPLACE VIEW api.gabarit_acoustique_anoures_short AS (
