...
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_long TO coleo_test_user;
GRANT ALL ON TABLE api.gabarit_acoustique_chiropteres_long TO glaroc;
GRANT ALL ON TABLE api.gabarit_acoustique_chiropteres_long TO postgres;
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_long TO read_only_all;
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_long TO read_only_public;
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_long TO read_write_all;
...
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_short TO coleo_test_user;
GRANT ALL ON TABLE api.gabarit_acoustique_chiropteres_short TO glaroc;
GRANT ALL ON TABLE api.gabarit_acoustique_chiropteres_short TO postgres;
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_short TO read_only_all;
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_short TO read_only_public;
GRANT SELECT ON TABLE api.gabarit_acoustique_chiropteres_short TO read_write_all;