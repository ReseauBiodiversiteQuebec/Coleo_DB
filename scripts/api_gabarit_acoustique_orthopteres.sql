-------------------------------------------------------------------------------
-- VIEW api.gabarit_acoustique_orthopteres_long
-- DESCRIPTION Representation of the data for the acoustique_orthoptères campaign
-------------------------------------------------------------------------------

-- CREATE VIEW FOR ACOUSTIQUE CHIROPTERES CAMPAIGN
-- View: api.gabarit_acoustique_orthopteres_long

-- DROP VIEW api.gabarit_acoustique_orthopteres_long;

CREATE OR REPLACE VIEW api.gabarit_acoustique_orthopteres_long AS (
...
GRANT SELECT ON TABLE api.gabarit_acoustique_orthopteres_long TO coleo_test_user;
GRANT ALL ON TABLE api.gabarit_acoustique_orthopteres_long TO glaroc;
GRANT ALL ON TABLE api.gabarit_acoustique_orthopteres_long TO postgres;
GRANT SELECT ON TABLE api.gabarit_acoustique_orthopteres_long TO read_only_all;
GRANT SELECT ON TABLE api.gabarit_acoustique_orthopteres_long TO read_only_public;
GRANT SELECT ON TABLE api.gabarit_acoustique_orthopteres_long TO read_write_all;

-------------------------------------------------------------------------------
-- VIEW api.gabarit_acoustique_orthopteres_short
-- DESCRIPTION Short representation of the data for the acoustique_orthoptères campaign
-------------------------------------------------------------------------------

-- CREATE VIEW FOR ACOUSTIQUE CHIROPTERES CAMPAIGN
-- View: api.gabarit_acoustique_orthopteres_short

-- DROP VIEW api.gabarit_acoustique_orthopteres_short;

CREATE OR REPLACE VIEW api.gabarit_acoustique_orthopteres_short AS (
