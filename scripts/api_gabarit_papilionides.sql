-------------------------------------------------------------------------------
-- VIEW api.gabarit_papilionides_long
-- DESCRIPTION Representation of the data for the papilionidés campaigns
-------------------------------------------------------------------------------

-- CREATE VIEW FOR PAPILIONIDÉS CAMPAIGN
-- View: api.gabarit_papilionides_long

-- DROP VIEW api.gabarit_papilionides_long;

CREATE OR REPLACE VIEW api.gabarit_papilionides_long AS (
    ...
    where c.type = 'papilionidés'
    order by (c.opened_at, s.site_code, c.technicians, c.notes)
);

GRANT SELECT ON TABLE api.gabarit_papilionides_long TO coleo_test_user;
GRANT ALL ON TABLE api.gabarit_papilionides_long TO glaroc;
GRANT ALL ON TABLE api.gabarit_papilionides_long TO postgres;
GRANT SELECT ON TABLE api.gabarit_papilionides_long TO read_only_all;
GRANT SELECT ON TABLE api.gabarit_papilionides_long TO read_only_public;
GRANT SELECT ON TABLE api.gabarit_papilionides_long TO read_write_all;


-------------------------------------------------------------------------------
-- VIEW api.gabarit_papilionies_short
-- DESCRIPTION Short representation of the data for the papilionidés campaign
-------------------------------------------------------------------------------
